...
project.add_assets("assets/export_presets/*", {
  destination: "data/export_presets/{name}",
});
project.add_assets("assets/keymap_presets/*", {
  destination: "data/keymap_presets/{name}",
});
project.add_assets("assets/licenses/**", {
  destination: "data/licenses/{name}",
});
project.add_assets("assets/plugins/*", { destination: "data/plugins/{name}" });
project.add_assets("assets/meshes/*", {
  destination: "data/meshes/{name}",
  noembed: true,
});
